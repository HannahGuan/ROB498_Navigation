...
class JoystickBase:
    def __init__(self, algorithm_name: Optional[str] = "socnav"):
        from pre_brne_func import brne_prediction
        from predictor import Predictor
        self.history = {}
        self.agent_trajectory_record = {}
        self.llm_tool = Predictor()
        # self.brne_function = brne_prediction()
    ...
    def listen_once(self, data_type: Optional[int] = 2) -> bool:
        ...
        if response_len > 0:
            ...
            if data_type == 0:
                ...
                self.record_agents = data_json["pedestrians"]
